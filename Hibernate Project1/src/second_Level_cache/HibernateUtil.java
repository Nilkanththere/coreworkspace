...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory()
	{
		...
		m.put(Environment.URL,"jdbc:mysql://localhost:3306/test1");
		...
		m.put(Environment.USE_SECOND_LEVEL_CACHE,"true");
		m.put(Environment.CACHE_REGION_FACTORY,"org.hibernate.cache.ehcache.EhCacheRegionFactory");
